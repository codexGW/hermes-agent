    ...
    def flush_memories(self, messages: list = None, min_turns: int = None):
        ...
        try:
            ...
            if self.api_mode == "codex_responses" and not _aux_available:
                ...
                # Auxiliary client returns an OpenAI-shaped response regardless of
                # the main provider path, so prefer its tool_calls directly.
        ...
        def _run_tool(index, tool_call, function_name, function_args):
            ...
            try:
                try:
                    ...
                    if "unexpected keyword argument" not in str(tool_error):
                        raise
